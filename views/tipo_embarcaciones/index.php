<div class="container-fluid text-center pt-5">
        ...
        <div class="row justify-content-center mb-3">
            <form class="col-lg-4 p-5 border bg-light rounded" id="formTipos">
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-12">
                        <label for="operacion">Nombre de la embarcación</label>
        ...
        <!-- <script src="build/js/tipo_embarcaciones/index.js"></script> -->