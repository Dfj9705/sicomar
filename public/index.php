...
$router->post('/API/medio/guardar',[MedioController::class,'guardarAPI']);
$router->post('/API/medio/modificar',[MedioController::class,'modificarAPI']);
$router->post('/API/medio/eliminar',[MedioController::class,'eliminarAPI']);
$router->get('/API/medio/buscar',[MedioController::class,'buscarAPI']);
